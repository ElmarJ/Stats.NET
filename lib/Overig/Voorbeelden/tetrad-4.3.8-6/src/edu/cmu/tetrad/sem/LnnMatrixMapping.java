 ...
 */
public class LnnMatrixMapping implements LnnMapping, TetradSerializable {
     ...
     */
    public LnnMatrixMapping(LnnIm lnnIm, Parameter parameter, DoubleMatrix2D matrix,
            int i, int j) {
        if (lnnIm == null) {
     ...
     */
    public static LnnMatrixMapping serializableInstance() {
        return new LnnMatrixMapping(LnnIm.serializableInstance(),
