...
namespace System.ComponentModel.Composition.ReflectionModel
{
    ...
    public class ReflectionParameterImportDefinitionTests
    {
        ...
        {
            LazyInit<ParameterInfo> parameter = CreateLazyParameter();
            IEnumerable<string> requiredMetadata = new string[] { "Foo" };
        ...
        private LazyInit<ParameterInfo> CreateLazyParameter()
        {
