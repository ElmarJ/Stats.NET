...
namespace ToolboxLibrary
{
    ...
    public class ToolboxUIManager : IPartImportsSatisfiedNotification
	{
        ...
        private Export<Type, IToolboxItemMetadataView>[] toolboxItems = null;
        ...
        public void PopulateData()
        {
            ...
            {
                if (tabDictionary.ContainsKey(toolboxItem.MetadataView.Category))
                    tab = tabDictionary[toolboxItem.MetadataView.Category];
                else
                {
                    tab = new ToolboxTab();
                    tab.Name = toolboxItem.MetadataView.Category;
                    tab.ToolboxItems = new Collection<ToolboxItem>();
                    tabDictionary.Add(toolboxItem.MetadataView.Category, tab);
                }
                ToolboxItem ti = new ToolboxItem();
                ti.Type = toolboxItem.GetExportedObject();
                ti.Name = toolboxItem.GetExportedObject().Name;
