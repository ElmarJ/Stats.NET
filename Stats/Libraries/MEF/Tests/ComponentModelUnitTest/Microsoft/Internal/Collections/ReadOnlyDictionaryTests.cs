...
namespace Microsoft.Internal.Collections
{
    ...
    public class ReadOnlyDictionaryTests
    {
        ...
        public void TryGetValue()
        {
            ...
            Assert.IsTrue(ret, "Expecting TryGetExportedObject to return true for wrapped key");
            Assert.AreEqual("Value1", result, "Expecting TryGetExportedObject to return wrapped value");
        }
