...
namespace MathLib.Statistics
{
    public class DataSet: IEnumerable<DataRow>
    {
        ...
        public DataSet(System.Data.DataTable dataTable)
        {
        ...
        public DataSet(): this(new System.Data.DataTable())
        {
        }
        ...
        {
            return
                GetSumOfProducts(variable1, variable2) / this.CaseCount - variable1.Mean * variable2.Mean;
        }
        ...
        internal double GetSumOfProducts(Variable variable1, Variable variable2)
        {
