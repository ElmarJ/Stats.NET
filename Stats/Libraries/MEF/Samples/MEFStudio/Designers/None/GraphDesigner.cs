...
namespace Designers
{
    ...
    public class GraphDesignerFactory : HostSurfaceFactory
    {
        ...
        public override IEnumerable<Export<Action<HostSurface>, ICommandMetadataView>> GetCommands()
        {
            return Commands.Where(c => c.MetadataView.Language == "None" && c.MetadataView.ItemType == "GraphDesigner");
        }
    }
