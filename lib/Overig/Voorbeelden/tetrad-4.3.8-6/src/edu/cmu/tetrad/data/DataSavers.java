...
public final class DataSavers {
     ...
     */
    public static void saveContinuousData(RectangularDataSet dataSet,
            Writer out, char separator) throws IOException {
        NumberFormat nf = NumberFormatUtil.getInstance().getNumberFormat();
        StringBuffer buf = new StringBuffer();
//        buf.append("/continuousdata\n");
     ...
     * @throws IOException If there is some problem dealing with the writer.
     */
    public static void saveDiscreteData(RectangularDataSet dataSet, Writer out,
            char separator) throws IOException {
        StringBuffer buf = new StringBuffer();

        boolean isCaseMultipliersSet = dataSet.isMulipliersCollapsed();

        if (isCaseMultipliersSet) {
            buf.append("MULT");
            buf.append(separator);
        }
