...
namespace System.ComponentModel.Composition
{
    ...
    public class CompositionContainerCollectionTests
    {
        ...
        public void ValidateSupportedImportCollectionAssignments()
        {
            ...
            batch.AddExportedObject("Value", 32);
            batch.AddExportedObject("Value", 43);
        ...
        public class NamelessImporter
        {
            ...
            [ImportMany]
            public ExportCollection<int> ReadWriteMetadata { get; set; }
        }
        ...
        {
            [ImportMany("Value")]
            public ExportCollection<int> WriteOnlyExportCollection
            {
                set { PublicExportCollection = value; }
            }

            public ExportCollection<int> PublicExportCollection { get; set; }
        }
        ...
        public void ImportCollections_WriteOnlyExportCollection()
        {
            ...
            batch.AddPart(importer);
            values.ForEach(v => batch.AddExportedObject("Value", v));

            container.Compose(batch);

            EnumerableAssert.AreEqual(values, importer.PublicExportCollection.Select(export => export.GetExportedObject()));            
        }
        ...
        {
            ExpectedErrorOnSetImport(new InvalidImporterNonCollection(),
        ...
        public void ImportCollectionsExceptionGettingValue()
        {
            ...
            batch.AddExportedObject("Value", 0);
