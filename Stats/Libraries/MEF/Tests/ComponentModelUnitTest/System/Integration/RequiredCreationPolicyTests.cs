...
namespace Tests.Integration
{
    ...
    public class RequiredCreationPolicyTests
    {
        ...
        public void RequiredAnyImporterImplicit_ShouldIncludeAll()
        {
            ...
            var importer = container.GetExportedObject<RequiredAnyImporterImplicit>();
        ...
        public void RequiredAnyImporterExplicit_ShouldIncludeAll()
        {
            ...
            var importer = container.GetExportedObject<RequiredAnyImporterExplicit>();
        ...
        public void RequiredSharedImporter_ShouldFilterNonShared()
        {
            ...
            var importer = container.GetExportedObject<RequiredSharedImporter>();
        ...
        public void RequiredNonSharedImporter_ShouldFilterShared()
        {
            ...
            var importer = container.GetExportedObject<RequiredNonSharedImporter>();
