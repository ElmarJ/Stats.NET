...
namespace MathLib.Core.Data
{
    ...
    public class Variable: IVariable
    {
        ...
        public Variable(DataColumn column, DataMatrix dataMatrix)
        {
            this.column = column;
        ...
        public virtual Observation NewObservation(Record record)
        {
            return new NummericalObservation(record, this);
        }
