...
namespace Microsoft.Samples.XFileExplorer
{
    ...
    public partial class Shell : Window, IPartImportsSatisfiedNotification
    {
        ...
        private void ReloadAllViews()
        {
            ...
            foreach (var view in _views.OrderBy(i => i.MetadataView.DockId))
            {
                ...
                switch (view.MetadataView.Docking)
                {
                    ...
                    default:
                        TabItem item = RightPanelTabs.Items.Cast<TabItem>().FirstOrDefault(i => (int)i.Tag == view.MetadataView.DockId);
                        if (item != null)
                        {
                        ...
                        else
                        {
                            ...
                            grid.Children.Add(childPane);
                            item = new TabItem();
                            item.Header = view.MetadataView.Name;
                            item.Content = grid;
                            item.Tag = view.MetadataView.DockId;
                ...
                mi.Header = view.MetadataView.Name;
                mi.IsCheckable = true;
                mi.IsChecked = view.MetadataView.Hidden ? false : true;
                ...
                childPane.Visibility = view.MetadataView.Hidden ? Visibility.Hidden : Visibility.Visible;
            }
        }
        ...
        private void ViewMenu_CheckChanged(object sender, RoutedEventArgs e)
        {
            ...
            UserControl view = _views.First(i => i.MetadataView.Name == mi.Header.ToString()).GetExportedObject();
            if (view != null)
