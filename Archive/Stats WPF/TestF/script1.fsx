...
// Simple computations in F# Interactive
// ---------------------------------------------------------------
// Below is a simple computation.  Note how interactive entries are terminated
// with ';;'.  You can run this code by starting F# Interactive - go to the
