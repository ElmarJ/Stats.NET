 ...
 * @version $Revision: 6056 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
...
//        RectangularDataSet dataSet = bayesIm.simulateData(sampleSize);
    ...
    private void checkSearch(String inputGraph, String outputGraph, Knowledge knowledge) {
        ...
        Graph compareGraph = GraphConverter.convert(outputGraph);
        ...
        assertTrue(resultGraph.equals(compareGraph));
