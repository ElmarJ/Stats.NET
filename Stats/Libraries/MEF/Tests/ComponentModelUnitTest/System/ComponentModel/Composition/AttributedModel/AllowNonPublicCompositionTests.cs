...
namespace System.ComponentModel.Composition
{
    ...
    public class AllowNonPublicCompositionTests
    {
        ...
        public void TestPublicImportsExpectingPublicExportsFromCatalog()
        {
            ...
            container.GetExportedObject<PublicImportsExpectingPublicExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestInternalImportsExpectingPublicExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<InternalImportsExpectingPublicExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestPublicImportsExpectingInternalExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<PublicImportsExpectingInternalExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestInternalImportsExpectingInternalExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<InternalImportsExpectingInternalExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestPublicImportsExpectingProtectedExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<PublicImportsExpectingProtectedExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestInternalImportsExpectingProtectedExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<InternalImportsExpectingProtectedExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestPublicImportsExpectingProtectedInternalExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<PublicImportsExpectingProtectedInternalExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestInternalImportsExpectingProtectedInternalExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<InternalImportsExpectingProtectedInternalExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestPublicImportsExpectingPrivateExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<PublicImportsExpectingPrivateExports>().VerifyIsBound();
        }
        [TestMethod]
        public void TestInternalImportsExpectingPrivateExportsFromCatalog()
        {
            var cat = CatalogFactory.CreateDefaultAttributed();
            var container = new CompositionContainer(cat);
            container.GetExportedObject<InternalImportsExpectingPrivateExports>().VerifyIsBound();
        }
    }
