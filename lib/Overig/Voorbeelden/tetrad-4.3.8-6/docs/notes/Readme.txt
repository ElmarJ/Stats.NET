$Revision: 3042 $ $Date: 2005-02-20 17:35:48 -0500 (Sun, 20 Feb 2005) $
...
4. Change directory to where the build.xml script is for this project;
in this directory, type "ant".

5. For information on available targets in the build.xml script, type
"ant -projecthelp" or just read the build.xml file. (Typing "ant"
