...
namespace System.ComponentModel.Composition
{
    ...
    public class ComposablePartExtensibilityTests
    {
        ...
        public void PhaseTest()
        {
            ...
            batch.AddExportedObject("Import1", 20);
            batch.AddPart(part);
        ...
        public void ConstructorInjectionSimpleCase()
        {
            ...
            batch.AddExportedObject<IBar>(new Bar("Bar Value"));
            container.Compose(batch);

            var import = container.GetExport<Foo>();
            var foo = import.GetExportedObject();
        ...
        public void ConstructorInjectionCycle()
        {
            ...
            CompositionAssert.ThrowsErrors(ErrorId.CompositionEngine_PartCannotSetImport,
                                           ErrorId.CompositionEngine_PartCannotSetImport, RetryMode.DoNotRetry, () =>
            {
                container.Compose(batch);
            });
        }
    ...
    internal class ConstructorInjectionComposablePart : ConcreteComposablePart
    {
        ...
        public override void SetImport(ImportDefinition definition, IEnumerable<Export> exports)
        {
            _imports[definition] = exports.First().GetExportedObject();
        }
    }
}
