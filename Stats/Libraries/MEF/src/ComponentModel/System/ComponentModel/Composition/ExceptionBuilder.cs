...
namespace System.ComponentModel.Composition
{
    internal static class ExceptionBuilder
    {
        ...
        public static CompositionException CreateCannotGetExportedObject(ComposablePart part, ExportDefinition definition, Exception innerException)
        {
            Assumes.NotNull(part, definition, innerException);

            ICompositionElement element = part.ToElement();
            return new CompositionException(
                ErrorBuilder.CreateCannotGetExportedObject(part, definition, innerException));
        }
