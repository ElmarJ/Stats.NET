...
//        for (Parameter parameter : im.getLnnPm().getParameters()) {
//            Node nodeA = correctSemIm.getLnnPm().getGraph().getNode(parameter.getNodeA().getName());
//            Node nodeB = correctSemIm.getLnnPm().getGraph().getNode(parameter.getNodeB().getName());
//            double value;
//
...
//                        Parameter errorParam = correctSemIm.getLnnPm().getNodeParameter(correctSemIm.getLnnPm().getGraph().getExogenous(nodeA));
