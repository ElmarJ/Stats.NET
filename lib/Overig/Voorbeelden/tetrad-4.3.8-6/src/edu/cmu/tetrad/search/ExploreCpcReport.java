...
//            System.out.println(result);
            ...
            if (result.isDirectedFromTo(_a, _b) && result.isDirectedFromTo(_c, _b)) {
                collider++;
            } else if (result.isAmbiguous(new Triple(_a, _b, _c))) {
                unfaithful++;
            } else {
                noncollider++;
            }
...
//            System.out.println(result2);
            ...
            if (result2.isDirectedFromTo(_a, _b) && result2.isDirectedFromTo(_c, _b)) {
                collider2++;
            } else if (result2.isAmbiguous(new Triple(_a, _b, _c))) {
                unfaithful2++;
            } else {
                noncollider2++;
            }
...
//        }
    ...
    private boolean isUnshieldedNoncollider(Node a, Node b, Node c,
        ...
        if (graph.isAmbiguous(new Triple(a, b, c))) {
            return false;
        }
