...
public final class CountColumn extends AbstractList
    ...
    private CountColumn(final CountVariable var) {
        ...
        Arrays.fill(this.data, var.getIntMissingValue());
    }
    ...
    public final void add(int index, Object element) {
        ...
        if (index < this.size) {
            ...
            Arrays.fill(this.data, this.size, index,
                    this.variable.getIntMissingValue());
            this.data[index] = datum;
            this.size = index + 1;
        }
    }
    ...
    private void ensureCapacity(int minCapacity) {
        ...
        if (minCapacity > oldCapacity) {
            ...
            Arrays.fill(this.data, variable.getIntMissingValue());
    ...
    private int getValueFromObject(Object element) {
        if ("*".equals(element)) {
            return variable.getIntMissingValue();
        }
