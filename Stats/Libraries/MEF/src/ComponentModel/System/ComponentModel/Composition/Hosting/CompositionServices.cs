...
namespace System.ComponentModel.Composition.Hosting
{
    internal static class CompositionServices
    {
        ...
        internal static Type GetContractTypeFromImport(this IAttributedImport import, ImportCardinality cardinality, ImportType importType)
        {
            ...
            else if (cardinality == ImportCardinality.ZeroOrMore && importType.ElementType != null)
            {
        ...
        internal static string GetContractNameFromImport(this IAttributedImport import, ImportCardinality cardinality, ImportType importType)
        {
            ...
            Type contractType = import.GetContractTypeFromImport(cardinality, importType);

            return AttributedModelServices.GetContractName(contractType); 
        }

        internal static string GetTypeIdentityFromImport(this IAttributedImport import, ImportCardinality cardinality, ImportType importType)
        {
            Type contractType = import.GetContractTypeFromImport(cardinality, importType);
        ...
        internal static void TryExportMetadataForMember(this MemberInfo member, out IDictionary<string, object> dictionary)
        {
            ...
            foreach (var attr in member.GetAttributes<Attribute>())
            {
                ...
                else if (!(attr is ExportAttribute) && attr.GetType().IsAttributeDefined<MetadataAttributeAttribute>())
                {
        ...
        internal static string GetContractNameFromContractTypeAttribute(Type type)
        {
            string name = null;
        ...
        {
            if (contractDefinition.RequiredTypeIdentity != null)
            {
                string exportTypeIdentity = definition.Metadata.GetValue<string>(CompositionConstants.ExportTypeIdentityMetadataName);

                if (!StringComparers.ContractName.Equals(contractDefinition.RequiredTypeIdentity, exportTypeIdentity))
                {
                    return false;
                }
            }
