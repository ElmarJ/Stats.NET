...
namespace System.ComponentModel.Composition
{
    ...
    /// </summary>
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Interface | AttributeTargets.Field | AttributeTargets.Property | AttributeTargets.Method, 
    ...
    public sealed class ExportAttribute : Attribute
    {
        ...
        ///         <see cref="ExportAttribute(Type)"/> or <see cref="ExportAttribute(string)"/>.
        ///     </para>
        ///     <para>
        ...
        ///         specify a contract name or type using either <see cref="ExportAttribute(Type)"/>
        ///         or <see cref="ExportAttribute(string)"/>.
        ///     </para>
        ///     <para>
        ///         The contract name is compared using a case-sensitive, non-linguistic comparison 
        ///         using <see cref="StringComparer.Ordinal"/>.
