...
namespace System.ComponentModel.Composition.ReflectionModel
{
    ...
    public class ReflectionMemberExportDefinitionTests
    {
        ...
        private static LazyInit<IDictionary<string, object>> CreateLazyMetadata(IDictionary<string, object> metadata)
        {
            return new LazyInit<IDictionary<string, object>>(() => metadata);
        }
