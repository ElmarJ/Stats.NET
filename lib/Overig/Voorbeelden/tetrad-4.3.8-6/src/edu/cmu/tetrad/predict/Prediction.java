 ...
 * @version $Revision: 5546 $ $Date: 2006-01-08 23:44:17 -0500 (Sun, 08 Jan
 *          2006) $
 */
            ...
            if (beforeX.contains(currTwo)) {        //redundant
                ...
                while (!adj.isEmpty()) {
                    ...
                    if (beforeX.contains(possThree) && ((!defT_possF &&
                            !pag.defNonCollider(one, currTwo, possThree)) || (
                            defT_possF &&
                                    pag.defCollider(one, currTwo, possThree))))
                    {
