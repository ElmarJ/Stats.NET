...
namespace System.ComponentModel.Composition.ReflectionModel
{
    ...
    internal class ImportType
    {
        ...
        {
            if (type == typeof(Export))
            {
                return new SpecificLazyType(null, null);
            }
        ...
        internal class SpecificLazyType
        {
            ...
            {
                this.ElementType = elementType ?? ExportServices.DefaultExportedObjectType;
                this.MetadataViewType = metadataViewType ?? ExportServices.DefaultMetadataViewType;
