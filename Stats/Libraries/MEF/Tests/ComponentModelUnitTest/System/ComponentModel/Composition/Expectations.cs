...
namespace System.ComponentModel.Composition
{
    internal static class Expectations
    {
        ...
        public static IEnumerable<string[]> GetRequiredMetadata()
        {
            ...
            yield return new string[] { "a", "b" };
            yield return new string[] { "a", "b", "c" };
            yield return new string[] { "Metadata", "Metadata", "Metadata" };
        }

        public static IEnumerable<string[]> GetRequiredMetadataWithEmpty()
        {
