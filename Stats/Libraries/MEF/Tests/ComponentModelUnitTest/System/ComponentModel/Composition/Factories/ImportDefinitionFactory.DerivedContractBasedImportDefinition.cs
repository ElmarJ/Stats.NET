...
namespace System.ComponentModel.Composition.Factories
{
    partial class ImportDefinitionFactory
    {
        private class DerivedContractBasedImportDefinition : ContractBasedImportDefinition
        {
            ...
            public DerivedContractBasedImportDefinition(string contractName, IEnumerable<string> requiredMetadata, ImportCardinality cardinality, bool isRecomposable, bool isPrerequisite)
            {
