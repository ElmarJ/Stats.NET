...
namespace System.ComponentModel.Composition.Factories
{
    ...
    internal static partial class ImportDefinitionFactory
    {
        ...
        {
            return Create(contractName, (IEnumerable<string>)null, ImportCardinality.ExactlyOne, true, false);
        }

        public static ImportDefinition Create(string contractName, IEnumerable<string> requiredMetadata)
        {
        ...
        {
            return Create(contractName, (IEnumerable<string>)null, cardinality, isRecomposable, isPrerequisite);
        }

        public static ImportDefinition Create(string contractName, ImportCardinality cardinality)
        {
            return Create(contractName, (IEnumerable<string>)null, cardinality, false, false);
        }

        public static ImportDefinition Create(string contractName, bool isRecomposable)
        {
            return Create(contractName, (IEnumerable<string>)null, ImportCardinality.ExactlyOne, isRecomposable, false);
        }

        public static ImportDefinition Create(string contractName, bool isRecomposable, bool isPrerequisite)
        {
            return Create(contractName, (IEnumerable<string>)null, ImportCardinality.ExactlyOne, isRecomposable, isPrerequisite);
        }

        public static ImportDefinition Create(string contractName, IEnumerable<string> requiredMetadata, ImportCardinality cardinality, bool isRecomposable, bool isPrerequisite)
        {
        ...
        {
            return new ContractBasedImportDefinition(contractName, (string)null, (IEnumerable<string>)null, cardinality, isRecomposable, isPrerequisite, CreationPolicy.Any);
        }
    }
}
