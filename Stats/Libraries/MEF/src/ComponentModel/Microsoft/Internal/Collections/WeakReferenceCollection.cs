...
namespace Microsoft.Internal.Collections
{
    ...
    {
        private readonly List<WeakReference<T>> _items = new List<WeakReference<T>>();
        ...
        public void Add(T item)
        {
            ...
            this._items.Add(new WeakReference<T>(item));
        }
        ...
        public T[] AliveItemsToArray()
        {
            return this._items
                .Select(weakItem => weakItem.Target)
                .WhereNotNull()
                .ToArray();
        }
    }
