 ...
 * @version $Revision: 5989 $ $Date: 2006-01-09 13:18:07 -0500 (Mon, 09 Jan
 *          2006) $
...
public final class Pag implements TetradSerializable, Graph {
    ...
    public boolean defNonCollider(Node node1, Node node2, Node node3) {
        return this.graph.defNonCollider(node1, node2, node3);
    }

    public boolean defCollider(Node node1, Node node2, Node node3) {
        return this.graph.defCollider(node1, node2, node3);
    }
