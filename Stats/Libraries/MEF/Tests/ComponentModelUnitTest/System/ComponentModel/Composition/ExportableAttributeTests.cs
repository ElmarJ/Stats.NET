...
namespace System.ComponentModel.Composition
{
    ...
    public class MetadataAttributeTests
    {
        ...
        public void UntypedStructureTest()
        {
            ...
            var export = container.GetExport<BasicTestComponent>();
        ...
        public void StronglyTypedStructureTest()
        {
            ...
            Assert.IsNotNull(export.MetadataView, "It should have metadata");
            Assert.AreEqual("One", export.MetadataView.String1, "Property should copy straight across");
            Assert.AreEqual("Two", export.MetadataView.String2, "Property should copy straight across");
            Assert.IsTrue(export.MetadataView.Numbers.Contains(1), "Should have 1 in the list");
            Assert.IsTrue(export.MetadataView.Numbers.Contains(2), "Should have 2 in the list");
            Assert.IsTrue(export.MetadataView.Numbers.Contains(3), "Should have 3 in the list");
            Assert.AreEqual(3, export.MetadataView.Numbers.Length, "Should be three numbers total");
        }
#endif //!SILVERLIGHT
