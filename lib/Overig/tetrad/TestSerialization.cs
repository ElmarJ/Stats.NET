...
///////////////////////////////////////////////////////////////////////////////
using System;
using TetradSerializableUtils = edu.cmu.tetradapp.util.TetradSerializableUtils;
...
namespace edu.cmu
{
	...
	/// <summary> Performs basic tests to ensure that sessions saved out with previous "stable"
	...
	/// things things, like making sure serialVersionUID is set to a fixed getValue,
	...
	/// </author>
	/// <version>  $Revision: 4923 $ $Date: 2005-11-28 11:31:09 -0500 (Mon, 28 Nov
	/// 2005) $
	/// </version>
	/// <seealso cref="edu.cmu.tetradapp.util.TetradSerializableUtils">
	/// </seealso>
	public class TestSerialization:TestCase
	{
		public TestSerialization(System.String name):base(name)
		{
		}
		
		/// <summary> Tests to make sure sessions saved out using any version for which
		/// archived serialized class examplars can be loaded using the current
		/// version.
		/// </summary>
		public virtual void  testLoadabilility()
		{
			System.String serializableScope = "build/tetrad/classes/edu/cmu";
			System.String currentDirectory = "build/tetrad/serializable/current";
			System.String archiveDirectory = "archives";
			...
			catch (System.SystemException e)
			{
				...
				fail("TestSerialization.testBareLoadatility() failed! Please fix " + "errors.");
			}
		}
