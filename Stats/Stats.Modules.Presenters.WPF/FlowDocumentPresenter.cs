...
namespace Stats.Modules.Presenters
{
    public class FlowDocumentPresenter : Presenter<Block>
    {
        ...
        public override Block RenderTextElement(Stats.Core.Results.TextElement element)
        {
        ...
        public override Block RenderResults(Results element)
        {
            Section section = new Section();
            foreach (IElement subElement in element.Elements)
            {
                section.Blocks.Add(subElement.Render<Block>(this));
            }
            return section;
        }
    }
