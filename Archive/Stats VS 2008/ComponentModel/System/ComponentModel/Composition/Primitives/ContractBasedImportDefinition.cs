...
namespace System.ComponentModel.Composition.Primitives
{
    ...
    public class ContractBasedImportDefinition : ImportDefinition
    {
        ...
        ///         Derived types calling this constructor must override the <see cref="ContractName"/> 
        ///         property, and optionally, the <see cref="RequiredMetadata"/>, 
        ///         <see cref="ImportDefinition.Cardinality"/>, <see cref="ImportDefinition.IsPrerequisite"/>,
        ...
        public ContractBasedImportDefinition(string contractName, string requiredTypeIdentity, IEnumerable<string> requiredMetadata, 
            ...
            : base(cardinality, isRecomposable, isPrerequisite)
        {
        ...
        ///         <see cref="ContractName"/> and <see cref="RequiredMetadata"/> properties.
        ///     </para>
        /// </remarks>
        public override sealed Expression<Func<ExportDefinition, bool>> Constraint
        {   // NOTE: We seal the Constraint so that it can never be
            // out of sync with ContractName and RequiredMetadata.

            get
            {
                if (this._constraint == null)
                {
                    this._constraint = ConstraintServices.CreateConstraint(ContractName, RequiredTypeIdentity, RequiredMetadata, RequiredCreationPolicy);
                }
