...
namespace System.ComponentModel.Composition.Hosting
{
    ...
    public abstract partial class ExportProvider
    {
        ...
        /// </summary>
        public event EventHandler<ExportsChangedEventArgs> ExportsChanged;
        ...
        public IEnumerable<Export> GetExports(ImportDefinition definition)
        {
            ...
            ExportCardinalityCheckResult result = this.TryGetExportsCore(definition, out exports);
            switch(result)
            {
        ...
        ///     <paramref name="definition"/> is <see langword="null"/>.
        /// </exception>
        public bool TryGetExports(ImportDefinition definition, out IEnumerable<Export> exports)
        {
            Requires.NotNull(definition, "definition");
        ...
        {
            EventHandler<ExportsChangedEventArgs> changedEvent = this.ExportsChanged;
        ...
        private ExportCardinalityCheckResult TryGetExportsCore(ImportDefinition definition, out IEnumerable<Export> exports)
        {
            Assumes.NotNull(definition);

            exports = this.GetExportsCore(definition);
            if (exports == null)
            {
                exports = Enumerable.Empty<Export>();
            }

            return ExportServices.CheckCardinality(definition, exports);
        }
    }
}
