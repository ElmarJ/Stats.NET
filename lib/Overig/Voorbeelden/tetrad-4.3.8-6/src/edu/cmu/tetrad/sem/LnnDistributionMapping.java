 ...
 * @version $Revision$
 */
public class LnnDistributionMapping implements LnnMapping, TetradSerializable {
     ...
     */
    public LnnDistributionMapping(Distribution distribution, int index,
                               Parameter parameter) {
     ...
     */
    public static LnnDistributionMapping serializableInstance() {
        return new LnnDistributionMapping(NormalDistribution.serializableInstance(),
