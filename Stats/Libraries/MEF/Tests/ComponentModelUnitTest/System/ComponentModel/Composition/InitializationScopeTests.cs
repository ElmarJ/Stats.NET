...
namespace System.ComponentModel.Composition
{
    ...
    public class InitializationScopeTests
    {
        ...
        public void SingleContainerSimpleCompose()
        {
            ...
            batch.AddExportedObject("value1", "Hello");
            batch.AddExportedObject("value2", "World");
        ...
        public void SingleContainerPartReplacement()
        {
            ...
            CompositionBatch batch = new CompositionBatch();
            var export1Key = batch.AddExportedObject("value1", "Hello");
            batch.AddExportedObject("value2", "World");
            ...
            batch.AddExportedObject("value1", "Goodbye");
            container.Compose(batch);
        ...
        public void ParentedContainerPartReplacement()
        {
            ...
            CompositionBatch batch = new CompositionBatch();
            var importPart = PartFactory.CreateImporter(true, "value1", "value2");
            var exportKey = batch.AddExportedObject("value1", "Parent");
            ...
            batch.AddExportedObject("value1", "New Parent");
            container.Compose(batch);
        ...
        public void SelectiveRecompose()
        {
            ...
            var exportKey = batch.AddExportedObject("dynamic", 1);
            batch.AddExportedObject("stable", 42);
            container.Compose(batch);
            ...
            batch.RemovePart(exportKey);
            batch.AddExportedObject("dynamic", 2);
            container.Compose(batch);
