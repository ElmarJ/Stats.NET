...
namespace Contracts
{
    public abstract class HostSurfaceFactory
    {
        ...
        protected Export<Action<HostSurface>, ICommandMetadataView>[] Commands = null;
        ...
        public abstract IEnumerable<Export<Action<HostSurface>, ICommandMetadataView>> GetCommands();
    }
}
