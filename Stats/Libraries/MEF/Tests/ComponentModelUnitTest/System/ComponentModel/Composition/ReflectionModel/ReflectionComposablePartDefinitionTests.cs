...
namespace System.ComponentModel.Composition.ReflectionModel
{
    ...
    public class ReflectionComposablePartDefinitionTests
    {
        ...
        {
            return (ReflectionComposablePartDefinition)ReflectionModelServices.CreatePartDefinition(partType, 
                new LazyInit<IEnumerable<ImportDefinition>>(imports), 
                new LazyInit<IEnumerable<ExportDefinition>>(exports), 
        ...
        public void Constructor()
        {
            ...
            LazyInit<Type> expectedLazyType = expectedType.AsLazy();
        ...
        private static List<ImportDefinition> CreateImports(Type type)
        {
            ...
            {
                imports.Add(new ReflectionMemberImportDefinition(new LazyMemberInfo(property), "Contract", (string)null, new string[] { "Key1" }, ImportCardinality.ZeroOrOne, true, CreationPolicy.Any, new TypeOrigin(type)));
            }
        ...
        private static List<ExportDefinition> CreateExports(Type type)
        {
            ...
            foreach (PropertyInfo property in type.GetProperties())
            {
                exports.Add(ReflectionModelServices.CreateExportDefinition(new LazyMemberInfo(property), "Contract", new LazyInit<IDictionary<string, object>>(() => null), new TypeOrigin(type)));
            }
