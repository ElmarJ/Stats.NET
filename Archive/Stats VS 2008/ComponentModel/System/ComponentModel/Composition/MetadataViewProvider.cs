        ...
        public static TMetadataView GetMetadataView<TMetadataView>(IDictionary<string, object> metadata)
        {
            ...
            else
            {
                ...
                if (metadataViewType.IsInterface)
                {
                    ...
                    {
                        throw new NotSupportedException(string.Format(CultureInfo.InvariantCulture, Strings.NotSupportedInterfaceMetadataView, metadataViewType.FullName), ex);
                    }
                }
                else
                {
                ...
                catch(TargetInvocationException ex)
                {
                    ...
                    if(metadataViewType.IsInterface)
                    {
                        if(ex.InnerException.GetType() == typeof(InvalidCastException))
                        {
                            ...
                            throw new CompositionContractMismatchException(string.Format(CultureInfo.InvariantCulture, 
