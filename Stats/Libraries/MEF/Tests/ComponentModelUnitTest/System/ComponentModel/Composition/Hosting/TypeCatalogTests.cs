    ...
    public class TypeCatalogTests
    {
        ...
        public void ICompositionElementDisplayName_SingleTypeAsTypesArgument_ShouldIncludeCatalogTypeNameAndTypeFullName()
        {
            ...
            foreach (var e in expectations)
            {
                ...
                string expected = string.Format("TypeCatalog (Types=\"{0}\")", e.FullName);
        ...
        public void ICompositionElementDisplayName_ValueAsTypesArgument_ShouldIncludeCatalogTypeNameAndTypeFullNames()
        {
            ...
            expectations.Add(new Type[] { typeof(Type) },
                             String.Format("TypeCatalog (Types=\"{0}\")", Strings.TypeCatalog_Empty));

            expectations.Add(new Type[] { typeof(ExportValueTypeSingleton) },
                             "TypeCatalog (Types=\"System.ComponentModel.Composition.ExportValueTypeSingleton\")");

            expectations.Add(new Type[] { typeof(ExportValueTypeSingleton), typeof(ExportValueTypeSingleton) },
                             "TypeCatalog (Types=\"System.ComponentModel.Composition.ExportValueTypeSingleton, System.ComponentModel.Composition.ExportValueTypeSingleton\")");
            ...
            expectations.Add(new Type[] { typeof(ExportValueTypeSingleton), typeof(ExportValueTypeFactory) },
                             "TypeCatalog (Types=\"System.ComponentModel.Composition.ExportValueTypeSingleton, System.ComponentModel.Composition.ExportValueTypeFactory\")");
        ...
        public void ICompositionElementDisplayName_ShouldIncludeDerivedCatalogTypeNameAndTypeFullNames()
        {
            ...
            foreach (var e in expectations)
            {
                ...
                string expected = string.Format("DerivedTypeCatalog (Types=\"{0}\")", e.FullName);
        ...
        public void TwoTypesWithSameSimpleName()
        {
            ...
            NotSoUniqueName unique1 = container.GetExportedObject<NotSoUniqueName>();

            Assert.IsNotNull(unique1);

            Assert.AreEqual(23, unique1.MyIntProperty);

            NotSoUniqueName2.NotSoUniqueName nestedUnique = container.GetExportedObject<NotSoUniqueName2.NotSoUniqueName>();
        ...
        public void GettingFunctionExports()
        {
            ...
            ImportDefaultFunctions import = container.GetExportedObject<ImportDefaultFunctions>("ImportDefaultFunctions");
        ...
        public void AnExportOfAnInstanceThatFailsToCompose()
        {
            ...
            // Even though this export exists the object that needs to be created for this
            // export to be gathered cannot be bound so it fails.

            ExceptionAssert.Throws<CompositionException>(() =>
            {
                container.GetExportedObject<string>("ExportMyString");
            });
        }
        ...
        public void SharedPartCreation()
        {
            ...
            var sharedPart1 = container.GetExportedObject<MySharedPartExport>();
            Assert.AreEqual(41, sharedPart1.Value);
            var sharedPart2 = container.GetExportedObject<MySharedPartExport>();
        ...
        public void NonSharedPartCreation()
        {
            ...
            var nonSharedPart1 = container.GetExportedObject<MyNonSharedPartExport>();
            Assert.AreEqual(41, nonSharedPart1.Value);
            var nonSharedPart2 = container.GetExportedObject<MyNonSharedPartExport>();
        ...
        public void RecursiveNonSharedPartCreation()
        {
            ...
            {
                container.GetExportedObject<DirectCycleNonSharedPart>();
            });

            CompositionAssert.ThrowsError(ErrorId.CompositionEngine_PartCannotGetExportedObject, () =>
            {
                container.GetExportedObject<CycleNonSharedPart>();
            });

            CompositionAssert.ThrowsError(ErrorId.CompositionEngine_PartCannotGetExportedObject, () =>
            {
                container.GetExportedObject<CycleNonSharedPart1>();
            });

            CompositionAssert.ThrowsError(ErrorId.CompositionEngine_PartCannotGetExportedObject, () =>
            {
                container.GetExportedObject<CycleNonSharedPart2>();
            });

            CompositionAssert.ThrowsError(ErrorId.CompositionEngine_PartCannotGetExportedObject, () =>
            {
                container.GetExportedObject<CycleWithSharedPartAndNonSharedPart>();
            });

            Assert.IsNotNull(container.GetExportedObject<CycleSharedPart>());
            Assert.IsNotNull(container.GetExportedObject<CycleSharedPart1>());
            Assert.IsNotNull(container.GetExportedObject<CycleSharedPart2>());
            Assert.IsNotNull(container.GetExportedObject<NoCycleNonSharedPart>());
        }
        ...
        public void TryToDiscoverExportWithGenericParameter()
        {
            ...
            Assert.IsNull(container.GetExportedObjectOrDefault<object>(AttributedModelServices.GetContractName(typeof(ExportWithGenericParameter<>))));

            // This specific generic was not exported any where so it should fail
            Assert.IsNull(container.GetExportedObjectOrDefault<object>(AttributedModelServices.GetContractName(typeof(ExportWithGenericParameter<double>))));

            // This specific generic was exported so it should succeed
            Assert.IsNotNull(container.GetExportedObjectOrDefault<object>(AttributedModelServices.GetContractName(typeof(ExportWithGenericParameter<int>))));

            // Shouldn't discovoer static type with open generic
            Assert.IsNull(container.GetExportedObjectOrDefault<object>(AttributedModelServices.GetContractName(typeof(StaticExportWithGenericParameter<>))));

            // Should find a type that inherits from an export
            Assert.IsNotNull(container.GetExportedObjectOrDefault<object>(AttributedModelServices.GetContractName(typeof(ExportWhichInheritsFromGeneric))));

            // This should be exported because it is inherited by ExportWhichInheritsFromGeneric
            Assert.IsNotNull(container.GetExportedObjectOrDefault<object>(AttributedModelServices.GetContractName(typeof(ExportWithGenericParameter<string>))));
        }
