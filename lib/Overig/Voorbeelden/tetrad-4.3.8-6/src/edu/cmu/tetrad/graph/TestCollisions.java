...
public final class TestCollisions extends TestCase {
    ...
    private void checkGraph(Graph graph) {
        ...
        assertTrue(graph.defCollider(x1, x2, x3));
        ...
        assertTrue(graph.defNonCollider(x1, x2, x3));
        ...
        assertFalse(graph.defNonCollider(x1, x2, x3));
        assertFalse(graph.defCollider(x1, x2, x3));
