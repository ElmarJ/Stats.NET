 ...
 * @version $Revision: 5997 $ $Date: 2006-01-05 13:54:07 -0500 (Thu, 05 Jan
 *          2006) $
 * @see Endpoint
 */
public final class EdgeListGraph implements Graph {
    ...
    /**
     * Set of unfaithful triples.
     */
    private HashSet<Triple> unfaithfulTriples = new HashSet<Triple>();
...
//        GraphUtils.arrangeInCircle(this, 200, 200, 150);
    ...
    public boolean isAmbiguous(Triple triple) {
        return unfaithfulTriples.contains(triple);
    }
    ...
    public boolean addEdge(Edge edge) {
        ...
        if (edgeList1.contains(edge)) {
            throw new IllegalArgumentException(
                    "That edge is already in the graph. ");
        }
