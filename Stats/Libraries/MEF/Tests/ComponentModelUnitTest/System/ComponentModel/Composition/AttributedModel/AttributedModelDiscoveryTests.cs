...
namespace System.ComponentModel.Composition.AttributedModel
{
    ...
    public class AttributedModelDiscoveryTests
    {
        ...
        public abstract class BaseClassWithMethodExports
        {
            [Export("MyMethod1Base")]
            public virtual void MyMethod1() { }

            [Export("MyMethod2Base")]
            public virtual void MyMethod2() { }

            [Export("MyMethod3Base")]
            public virtual void MyMethod3() { }
        }

        public class DerivedClassWithInheritedMethodExports : BaseClassWithMethodExports
        {
        ...
        [TestMethod]
        public void CreatePartDefinition_TypeWithInheritedMethodExports_ShouldInheritExports()
        {
            var definition = CreateDefinition(typeof(DerivedClassWithInheritedMethodExports));

            EnumerableAssert.AreEqual(definition.ExportDefinitions.Select(e => e.ContractName),
                                "MyMethod1Base", // inherit directly from base
                                "MyMethod2Base", // inherit from base even though we override
                                "MyMethod3Base", // inherit from base and...
                                "MyMethod3Derived"); // from derived for the same method.
        }
        ...
        [WorkItem(551341)]
        [TestMethod]
        public void ShowBugInReflectionAPI()
        {
        ...
        [TestMethod]
        public void CreatePartDefinition_TypeWithInheritedPropertyExports_ShouldInheritExports()
        {
            var definition = CreateDefinition(typeof(DerivedClassWithInheritedPropertyExports));

            EnumerableAssert.AreEqual(definition.ExportDefinitions.Select(e => e.ContractName), "MyPropBase");
        }
