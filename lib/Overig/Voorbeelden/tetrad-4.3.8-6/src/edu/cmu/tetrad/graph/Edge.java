 ...
 * @version $Revision: 5948 $ $Date: 2006-01-11 13:36:55 -0500 (Wed, 11 Jan
 *          2006) $
 */
public class Edge implements TetradSerializable {
    ...
    public final boolean equals(Object o) {
        ...
        if (edge.getNode1().getName().equals(getNode1().getName()) &&
            ...
            return edge.getEndpoint1() == getEndpoint1() &&
                    edge.getEndpoint2() == getEndpoint2();
        }
        else if (edge.getNode1().getName().equals(getNode2().getName()) &&
                edge.getNode2().getName().equals(getNode1().getName())) {
            return edge.getEndpoint1() == getEndpoint2() &&
                    edge.getEndpoint2() == getEndpoint1();
        }
    ...
    public boolean pointingLeft(Endpoint endpoint1, Endpoint endpoint2) {
